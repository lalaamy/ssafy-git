...
title = data[0]['results'][0]['properties']['제목']['title'][0]['plain_text']
date = data[0]['results'][0]['properties']['일차']['number']
step = data[0]['results'][0]['properties']['단계']['select']['name']
subject = data[0]['results'][0]['properties']['과목']['multi_select'][0]['name']
